...
For more inspo, be sure to check out our upcoming event [Coding for a Cause](https://www.meetup.com/rladies-ottawa/events/306232274/?eventOrigin=group_upcoming_events) with Claudie Larouche!
...
All submissions from women and gender minorities based in the Canada will receive HexStickers! Among these, the most creative solution (selected by the R-Ladies Ottawa organizing team) will receive a $25 gift card to [Maker House](https://makerhouse.com/)!
...
As a starting point to get familiar with scrollytelling, Brittny used the [closeread] extensions from Quarto to show a fun way to look at data and text about action movies. You can find her submission [here](https://klaxonklaxoff.github.io/action_movies.html).