...
RLadies+ Ottawa is hosting another data challenge to celebrate International Women's Day 2026!
...
Although this challenge is hosted by *RLadies+* Ottawa, you don't have to use R to participate. You could use R, Python, a combination of the two, or anything you're comfortable with! 
...
On **Tuesday, April 28th, 2026 from 6pm-8pm**, RLadies+ Ottawa will host [a hybrid event](https://www.meetup.com/rladies-ottawa/events/313489859/?eventOrigin=your_events&utm_medium=referral&utm_campaign=event_card_savedevents_share_modal&utm_source=link&utm_version=v2&member_id=381181171) where participants can showcase their work. This is a great way to learn from one another and to connect with other like-minded individuals!
...
### Valerie Figuracion's submission

Valerie's project is a Shiny app in where the user provides their annual income, down payment %, and mortgage period, and then gets a personalized list of properties available at zillow.com at the time of the app launch.

The full code can be found [here](https://github.com/vmfiguracion/Affordability-Calculator/tree/main).

![A screenshot of Valerie's Shiny app](./images/affordability_calculator.png)

### Abibat Oki's submission

OC Transpo operates Ottawa's bus and light‑rail network. Abibat's project analyzes how well the network meets its service standards, how ridership fluctuates throughout the year, and the events that drive those fluctuations. Raw monthly and daily reporting data were reshaped and modelled in Power BI to create interactive dashboards that help transit planners identify bottlenecks and target improvements.

* **Live Dashboard:** [View Power BI Dashboard](https://app.powerbi.com/view?r=eyJrIjoiYzhmMTgxYzEtZTcyNC00YzM1LTg5ZTAtOTY3YzA2MTZlYjc1IiwidCI6IjFlNjMzNjFkLTJhODktNGMyNy04MTcwLTExNGE4MTVkZDA0ZiJ9)
* **README:** [View Project Repository & README](https://github.com/abibatoki/IWD-Data-Challenge-2026/blob/main/README.md)

![A screenshot of Abibat's Power BI dashboard](./images/octranspo_powerbi.png)
